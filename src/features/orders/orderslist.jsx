...
  const [deletingOrder, setDeletingOrder] = useState(false); // حالة جديدة للحذف
...
    setOrderToEdit(null);
    setDeletingOrder(false); // إعادة حالة التحميل للحذف
...
    setDeletingOrder(true); // ابدأ حالة التحميل
    try {
...
      setDeletingOrder(false); // أوقف التحميل عند حدوث خطأ
    }
  };
