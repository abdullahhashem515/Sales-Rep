// src/features/reports/VisitsReportPrintPreview.jsx
...
export default function VisitsReportPrintPreview({ show, onClose, reportData }) {
...
                <th className="py-2 px-3 border border-gray-300">اسم العميل</th>
                <th className="py-2 px-3 border border-gray-300">تاريخ الزيارة</th>
                <th className="py-2 px-3 border border-gray-300">نوع الزيارة</th>
                <th className="py-2 px-3 border border-gray-300">الملاحظات</th>
              </tr>
            </thead>
            <tbody>
...
                    <td className="py-2 px-3 border border-gray-200">{item.user?.name || "غير معروف"}</td>
                    <td className="py-2 px-3 border border-gray-200">{item.customer?.name || "غير معروف"}</td>
                    <td className="py-2 px-3 border border-gray-200">{item.visit_date}</td>
                    <td className="py-2 px-3 border border-gray-200">{visitTypeMap[item.visit_type] || item.visit_type}</td>
                    <td className="py-2 px-3 border border-gray-200">{item.note}</td>
                  </tr>
                ))
              ) : (
                <tr>
                  <td colSpan="6" className="py-4 text-center text-gray-500">لا توجد بيانات في هذا التقرير.</td>
                </tr>
              )}
            </tbody>
          </table>
