...
export default function ReportDetailsModal({ show, onClose, reportData }) {
  ...
  const dataToDisplay = reportData.length > 0 ? reportData : mockReportData;
          ...
          <table className="min-w-full text-right text-sm border-collapse">
            <thead>
              <tr className="bg-gray-100 border-b border-gray-300 text-gray-700">
                ...
                <th className="py-2 px-3 border border-gray-300">رقم الطلب</th>
                <th className="py-2 px-3 border border-gray-300">
                  تاريخ الطلب
                </th>
                <th className="py-2 px-3 border border-gray-300">حالة الطلب</th>
              </tr>
            </thead>
            <tbody>
