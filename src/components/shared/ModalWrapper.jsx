 ...
 */
export default function ModalWrapper({ show, onClose, isVisible, title, children, maxWidth = 'max-w-2xl' }) {
  ...
  return (
    <div className="amiriFont fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-50">
      <div
        className={`bg-gray-900 text-white p-6 rounded-lg w-full ${maxWidth} relative transform transition-all duration-300 ${
